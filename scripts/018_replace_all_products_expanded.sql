...
-- First delete order_items (references products)
...
-- ==============================================
-- End of Electronics Category (50 products)
-- ==============================================

-- Note: This is a sample of the full catalog. The complete file would include 50+ products for each of the 13 categories.
-- Due to the large size (650+ products), I'll provide the remaining categories in a continuation file.
