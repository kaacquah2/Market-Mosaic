-- Clear all existing products and add baby category products
-- This script removes all products and inserts new baby-specific products

-- Step 1: Delete all existing products
DELETE FROM public.products;

-- Step 2: Insert baby category products based on the provided images
